...
const PurchaseHistoryTable = ({ historyRecord }) => {
        ...
        <StyledContainer>
            ...
            >
                <TableHead>
                    ...
                    >
                        <HeadCellWhite >Purchase Category</HeadCellWhite>
                        <HeadCellWhite align="right"># of Purchases</HeadCellWhite>
                        <HeadCellWhite align="right">% of Purchase Total</HeadCellWhite>
                        <HeadCellWhite align="right">Purchase Total</HeadCellWhite>
                    </TableRow>
                </TableHead>
                <TableBody>
                    {historyRecord.purchaseNodes.map((node) => (
                        <TableRow
                            key={node.category}
                            sx={{
                                '&:nth-last-child(2) td, &:nth-last-child(2) th': { borderBottom: '2px solid rgba(255, 77, 148, 0.5)' }
                            }}
                        >
                    ...
                    >
                        ...
                        >
                            ...
                            <span className='history-table-bold'>
                                {historyRecord.luxTotal.toLocaleString('en-US', {minimumFractionDigits: 2, maximumFractionDigits: 2})}
                            </span>
                        </TableCellWhite>
                        <TableCell></TableCell>
                        <TableCell></TableCell>
